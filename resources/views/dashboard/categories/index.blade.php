...
<div class="table-responsive col-lg-8">
    <a href="/dashboard/categories/create" class="btn btn-primary btn-sm mb-3"><span data-feather="plus-circle"></span>
        Create new Category</a>

    @if (session()->has('success'))
    <div class="alert text-center alert-success alert-dismissible fade show my-5" role="alert">
        {{ session('success') }}
